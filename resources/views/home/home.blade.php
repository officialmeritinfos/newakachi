            ...
            <div class="row">
                ...
                <div class="col-lg-6 m-b-30" data-animate="fadeInLeft">
                    ...
                    <div class="m-b-40 f15">
                        <p style="color: #fff !important">Fixed Deposit (FD) Is an organized investment package that allows you as an investor to manage your Investment Portfolio with a higher interest rate other than the ordinary investment packages,this involves depositing and making withdrawals ‘monthly or yearly’.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                @foreach($services as $service)
                    <div class="col-lg-4 m-b-30" data-animate="fadeInLeft">
                        <div class="card" >
                            <img class="card-img-top" src="{{asset('home/serv/'.$service->photo)}}" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">{{$service->title}}</h5>
                                <p class="card-text">
                                    {{\Illuminate\Support\Str::words($service->short,50)}}
                                </p>
                                <a href="{{route('service.details',['id'=>$service->id])}}" class="btn btn-primary">Read more</a>
                            </div>
                        </div>
                    </div>
                @endforeach
